...
def main() -> int:
    ...
    cases = [
        (
            should_shed(inflight=8, max_inflight=8, assigned_count=0, idle_extra=extra) is False,
            "idle slave is not shed at busy inflight cap",
        ),
        (
            should_shed(inflight=11, max_inflight=8, assigned_count=0, idle_extra=extra) is False,
        ...
        (
            should_shed(inflight=7, max_inflight=8, assigned_count=3, idle_extra=extra) is False,
            "busy slave is not shed under inflight cap",
        ),
        (
            should_shed(inflight=0, max_inflight=8, assigned_count=0, idle_extra=extra) is False,
